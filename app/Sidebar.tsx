...
export const Sidebar: React.FC = () => {
  return (
    <nav className="flex flex-col py-14 pr-2 pl-5 mx-auto mt-2 w-full text-xl font-bold text-gray-100 bg-[#9CAD88] rounded-[36px]">
      ...
      <Link href="/dashboard-components" className="flex gap-5 self-start px-4 py-5 mt-32 text-black whitespace-nowrap rounded-2xl bg-stone-200 hover:bg-stone-300 transition-colors">
        <img
      ...
      <Link href="/devices-page-components" className="flex gap-5 self-center mt-5 max-w-full whitespace-nowrap w-[143px] hover:bg-[#8b9b78] transition-colors rounded-xl p-2">
        <img
      ...
      <Link href="/dwellers-page-components" className="flex gap-5 self-start mt-8 ml-4 hover:bg-[#8b9b78] transition-colors rounded-xl p-2">
        <img
      ...
      <Link href="/energy-page-components" className="flex gap-4 self-center mt-9 max-w-full w-[171px] hover:bg-[#8b9b78] transition-colors rounded-xl p-2">
        <img
      ...
      <Link href="/notification-page-components" className="flex gap-5 self-start mt-9 ml-5 hover:bg-[#8b9b78] transition-colors rounded-xl p-2">
        <img
      ...
      <Link href="/settings-page-components" className="flex gap-5 justify-between self-center mt-5 max-w-full w-[140px] hover:bg-[#8b9b78] transition-colors rounded-xl p-2">
        <img
          src="https://cdn.builder.io/api/v1/image/assets/e97f4b049aa04c0fb59c904d1d337327/3353ecd67f6d996bea70e27d460b6654b11ff3a34d80dcf8ca0969bf1cb06c88"
